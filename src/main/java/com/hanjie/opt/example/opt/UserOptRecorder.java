 ...
 */
@Component
public class UserOptRecorder implements IOptLogRecorder {

    /**
     * logger
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(UserOptRecorder.class);
    ...
    public boolean support(OptLogRecord record) {
        return record.getContextValue("userId") != null;
    }
    ...
    public void record(OptLogRecord record) {
        ...
        LOGGER.error(record.getContextValue("userId"));
        LOGGER.error("<----------------->");
    }
}
